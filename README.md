...
# <h1 id="about-project">📖 Codeniversity</h1>

> Codeniversity is the API for an online learning application like Udemy built with Express.js, MongoDb, and TypeScript.
...
- **User Auth**
- **Course CRUD**
- **Create and view course orders**
- **Course question and answer feature**
...
```sh
  cd my-folder
  git clone https://github.com/codepantha/codeniversity-api.git
```
...
Feel free to check the [issues page](https://github.com/codepantha/codeniversity-api/issues).
